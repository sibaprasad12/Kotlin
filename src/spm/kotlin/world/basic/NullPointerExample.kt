...
internal object NullPointerExample {
    ...
    var name1: String =
        "" // we cant assign null here, as it is non null variable, it will show compile time error
    var name2: String? =
        "SIbaprasad" // we can assign null value to the variable, as it is null variable
    ...
    fun main(args: Array<String>) {
        ...
        useOfVar()
        useOflateinit()
        exampleofNullpointerHandleing()
        useOfElvisOperator()
        useOfAsForSafeCasting()
    }
